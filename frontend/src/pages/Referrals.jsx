        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Track and manage specialist consultations for children at risk</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder="Search child or facility..."
                            value={searchText}
            ...
            {loading ? (
                ...
                <div className="bg-white border border-gray-200 rounded-3xl p-12 text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">No referrals found</h3>
                    <p className="text-gray-500 text-sm mt-1">Try changing your filters or search text</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div key={referral.referral_id} className="bg-white border border-gray-200 rounded-3xl p-5 hover:shadow-xl hover:shadow-indigo-50/50 transition-all group">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="text-right">
                                    <p className="text-[10px] text-gray-400 font-medium">REFERRAL DATE</p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-gray-900 leading-tight">{referral.child_name || `Child #${referral.child_id}`}</h3>
                                        <p className="text-xs text-gray-500">Risk Tier: <span className="text-red-500 font-semibold">{referral.risk_level_at_referral}</span></p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-50 rounded-2xl p-3 space-y-2">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-[10px] text-gray-400 font-medium uppercase leading-none">REFERRED TO</p>
                                            <p className="text-xs font-bold text-gray-700 truncate mt-1">{referral.referred_to || 'Not specified'}</p>
                                    ...
                                    <div className="flex items-center gap-2 border-t border-gray-100 pt-2">
                                        ...
                                        <div>
                                            <p className="text-[10px] text-gray-400 font-medium uppercase leading-none">EXPECTED BY</p>
                                            <p className="text-xs font-bold text-gray-700 mt-1">{referral.expected_completion_date ? new Date(referral.expected_completion_date).toLocaleDateString() : 'TBD'}</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md p-8 animate-in fade-in zoom-in duration-200">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-black text-gray-900">Complete Referral</h2>
                        ...
                        <div className="space-y-6">
                            <div>
                                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Outcome Summary</label>
                                <textarea
                                    className="w-full bg-gray-50 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-indigo-500 h-32"
                                    placeholder="Enter specialist findings, diagnosis, or recommendations..."
                                    id="outcome-summary"
                                />
                            </div>
